...
describe("ImagesController", () => {
  ...
  describe("findOne", () => {
    it("should return a image", async () => {
      ...
      jest.spyOn(service, "streamImage").mockReturnValue(new StreamableFile(Buffer.from("")));
  ...
  describe("findOneThumbnail", () => {
    it("should return a image", async () => {
      ...
      expect(await controller.findOneThumbnail("abcdef", mockRes)).toBeInstanceOf(StreamableFile);
    });
    ...
    describe("otherwise", () => {
      it('should throw the "NotFoundException"', async () => {
        ...
        await expect(controller.findOne("abcdef", mockRes)).rejects.toBeInstanceOf(TypeError);
      });
  ...
  describe("deleteCode", () => {
    ...
    describe("otherwise", () => {
      it('should throw the "NotFoundException"', async () => {
        ...
        await expect(controller.deleteCode("abcdef")).rejects.toBeInstanceOf(NotFoundException);
      });
    });
  });
