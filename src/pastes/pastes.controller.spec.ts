...
describe("PastesController", () => {
  ...
  describe("findOne", () => {
    ...
    describe("otherwise", () => {
      it('should throw the "NotFoundException"', async () => {
        ...
        await expect(controller.findOne("abcdef")).rejects.toBeInstanceOf(NotFoundException);
      });
    });
  });
  ...
  describe("create", () => {
    it("should create a paste", async () => {
      ...
      await expect(controller.create(mockFile)).resolves.toBeInstanceOf(GetPasteDto);
    });
  });
